...
Generated by Mapsoo Worldsmith 0.1.0-alpha.5.
...
- Semantic places: 3
- Godot target: 4.3+
- Minimum compatible importer: Mapsoo Pack Importer 0.1.0-alpha.5+
...
Semantic places are engine-neutral records in `runtime/places.json`. Stable place IDs are the identity contract; resolved coordinates are deterministic projections for this pack version.

...
1. Download and extract `mapsoo-sunny-meadow-v0.1.0-alpha.2.zip`.
2. Install the Mapsoo Pack Importer only from the [official GitHub release](https://github.com/babyrush0101-source/mapsoo-kids/releases/tag/v0.1.0-alpha.2).
...
- GitHub alpha release: https://github.com/babyrush0101-source/mapsoo-kids/releases/tag/v0.1.0-alpha.2
- Generator demo: https://babyrush0101-source.github.io/mapsoo-kids/
- Reproducible feedback: https://github.com/babyrush0101-source/mapsoo-kids/issues/new?template=bug-report.yml

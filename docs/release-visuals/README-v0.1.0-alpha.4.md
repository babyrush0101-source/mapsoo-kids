...
The Godot frame and its “publication pending” text are a timestamped pre-publication candidate artifact. Those required Godot 4.3/4.7 Linux/Windows gates subsequently passed in the [public tag workflow](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29680728876), and the fixed-hash GitHub prerelease is now published. itch.io upload remains postponed. The visuals deliberately describe layered terrain, Terrain Set metadata, and basic Water collision—not a complete game, navigation, or pathfinding system.

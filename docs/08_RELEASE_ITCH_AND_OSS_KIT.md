...
当前已发布版本：`v0.1.0-alpha.4`

当前公开示例包 SHA-256：`a57e810baaf2f015d7db96bf0e88ab7b6340d476a61ade7447735a6109b8fb35`。Alpha.4 工作台、公开下载与 importer 已统一升版；11 个 GitHub Release 附件的远端 SHA-256 已登记。Alpha.4 的 itch.io operator kit 继续作为离线验证产物，不执行登录或上传。

已发布且不可变的版本：`v0.1.0-alpha.1`、`v0.1.0-alpha.2`、`v0.1.0-alpha.3`、`v0.1.0-alpha.4`
...
| Public repository | Provider、runner evidence、STOYO 请求契约、release architecture、安全重导入与 Alpha.4 四层地形已在默认分支 | [Alpha.4 release commit `87b9758`](https://github.com/babyrush0101-source/mapsoo-kids/tree/87b97585e4ef66c69dcbe65bea1058c797b1b4b0) |
...
| 可复现构建与测试 | Alpha.4 发布前 PR CI 与 tag release workflow 均通过 | [PR CI run](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29680618921)、[tag release workflow](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29680728876) |
| Godot 4.3/4.7 兼容 | Alpha.4 tag workflow 在 Linux/Windows 对同一个公开固定哈希包完成 exact-pack 导入 | [Linux 4.3](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29680728876/job/88176402206)、[Linux 4.7](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29680728876/job/88176402200)、[Windows 4.3](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29680728876/job/88176402211)、[Windows 4.7](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29680728876/job/88176402235) |
...
| GitHub alpha release | 四个不可变 prerelease 已公开；当前版本为 Alpha.4 | [`v0.1.0-alpha.4`](https://github.com/babyrush0101-source/mapsoo-kids/releases/tag/v0.1.0-alpha.4) |
...
| downloads / stars / forks | 2026-07-19：0 stars，0 forks；附件下载包含维护者发布审计且下载者身份不可见，因此计数不能证明外部采用 | [Alpha.4 release](https://github.com/babyrush0101-source/mapsoo-kids/releases/tag/v0.1.0-alpha.4)、[repository](https://github.com/babyrush0101-source/mapsoo-kids) |

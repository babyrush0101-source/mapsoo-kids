...
- [Draft PR #24](https://github.com/babyrush0101-source/mapsoo-kids/pull/24) 的实现提交 `d1317ea` 已完成公开 [check job](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29662576831/job/88127620978)；其中真实 Chrome exporter、远端 alpha.1 附件、80 个测试、双 Vite release 与 itch 套件门禁均通过；
- [Godot 4.3 job](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29662576831/job/88127703698) 与 [Godot 4.7 job](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29662576831/job/88127703719) 都下载 check job 上传的同一个固定哈希 12 文件 ZIP，并通过精确输出 `MAPSOO_PACK_CLI_OK pack_id=sunny-meadow cells=384 props=29`；
...
alpha.2 的宣传图统一使用“CI-gated”措辞，不把静态图片当执行证明。当前 candidate 的权威证明是上述实现提交 `d1317ea` 的 GitHub Actions job URL；合并与 tag 后仍须以对应新提交和 release workflow 的 job URL 为准。

...
| Public repository | Provider、runner evidence、STOYO 请求契约、release architecture、安全重导入、四层地形与 Alpha.5 语义地点已在默认分支 | [Alpha.5 release commit `b67e7f4`](https://github.com/babyrush0101-source/mapsoo-kids/tree/b67e7f41a5da30b2758bd972022e210361755eae) |
...
| GitHub alpha release | 五个不可变 prerelease 已公开；当前版本为 Alpha.5 | [`v0.1.0-alpha.5`](https://github.com/babyrush0101-source/mapsoo-kids/releases/tag/v0.1.0-alpha.5) |
...
| downloads / stars / forks | 2026-07-19：0 stars，0 forks；附件下载包含维护者发布审计且下载者身份不可见，因此计数不能证明外部采用 | [Alpha.5 release](https://github.com/babyrush0101-source/mapsoo-kids/releases/tag/v0.1.0-alpha.5)、[repository](https://github.com/babyrush0101-source/mapsoo-kids) |

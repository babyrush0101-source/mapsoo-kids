...
| --- | --- | --- |
| Public repository | 新版已在公开默认分支 | [main merge commit](https://github.com/babyrush0101-source/mapsoo-kids/tree/f36ef4d29020b3f7ceaf87d314ca1d80c0e44500) |
...
| 可复现构建与测试 | 公开 CI 已通过 | [main CI run](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29649158764) |
| Godot 4.3/4.7 兼容 | 两个公开 jobs 已通过 | [4.3 job](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29649158764/job/88092390515)、[4.7 job](https://github.com/babyrush0101-source/mapsoo-kids/actions/runs/29649158764/job/88092390497) |
...
```text
I am the primary maintainer. STOYO is the planned first real consumer, not claimed as external adoption. Public release, demo, CI, video, and feedback links are recorded above; the itch.io URL and external feedback remain pending. Mapsoo remains usable without an account, backend, or paid API and is designed as reusable OSS rather than STOYO-only code.
```

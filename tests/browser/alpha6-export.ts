import { buildAlpha6PortablePack } from '../../src/adapters/export-browser-pack-alpha6';
...
import { ALPHA6_PACK_VERSION } from '../../src/core/pack-manifest-alpha6';
import { ALPHA6_DEFAULT_WORLD_SPEC } from '../../src/core/world-spec';
...
const FIXED_COMPLETION_TIME = '2026-07-19T10:00:00.000Z';
...
async function exportDefaultPack(): Promise<void> {
  ...
  try {
    ...
    result.dataset.version = ALPHA6_PACK_VERSION;
